...
export const SHADOW_CHAIN_GAME_ADDRESS = '0xfE06900CEa98ca4D6F23Bc2fC1C39b51E0B89d9c' as const;
export const ARTIFACT_REGISTRY_ADDRESS = '0x6Ea113421CD20E275EFcbfA8cF2d1A9e38365530' as const;
...
export const shadowChainGameAbi = [
  ...
  { type: 'function', name: 'claimArtifact', inputs: [{ name: 'gameId', type: 'uint256', internalType: 'uint256' }, { name: 'cellX', type: 'uint8', internalType: 'uint8' }, { name: 'cellY', type: 'uint8', internalType: 'uint8' }, { name: 'proof', type: 'bytes', internalType: 'bytes' }, { name: 'publicInputs', type: 'bytes32[]', internalType: 'bytes32[]' }, { name: 'newInventoryCommitment', type: 'bytes32', internalType: 'bytes32' }], outputs: [], stateMutability: 'nonpayable' },
  ...
  { type: 'function', name: 'getGameMap', inputs: [{ name: 'gameId', type: 'uint256', internalType: 'uint256' }], outputs: [{ name: 'wallBitmap', type: 'uint256', internalType: 'uint256' }, { name: 'treasureSeed', type: 'bytes32', internalType: 'bytes32' }], stateMutability: 'view' },
  ...
  { type: 'function', name: 'joinGame', inputs: [{ name: 'gameId', type: 'uint256', internalType: 'uint256' }, { name: 'commitment', type: 'bytes32', internalType: 'bytes32' }, { name: 'inventoryCommitment', type: 'bytes32', internalType: 'bytes32' }], outputs: [], stateMutability: 'payable' },
  { type: 'function', name: 'getInventoryCommitment', inputs: [{ name: 'gameId', type: 'uint256', internalType: 'uint256' }, { name: 'player', type: 'address', internalType: 'address' }], outputs: [{ name: '', type: 'bytes32', internalType: 'bytes32' }], stateMutability: 'view' },
  ...
  { type: 'function', name: 'getTreasureSeed', inputs: [{ name: 'gameId', type: 'uint256', internalType: 'uint256' }], outputs: [{ name: '', type: 'bytes32', internalType: 'bytes32' }], stateMutability: 'view' },
  { type: 'function', name: 'getArtifactAtCell', inputs: [{ name: 'gameId', type: 'uint256', internalType: 'uint256' }, { name: 'x', type: 'uint8', internalType: 'uint8' }, { name: 'y', type: 'uint8', internalType: 'uint8' }], outputs: [{ name: '', type: 'uint8', internalType: 'uint8' }], stateMutability: 'view' },
  ...
  { type: 'event', name: 'ArtifactClaimedEvent', inputs: [{ name: 'gameId', type: 'uint256', indexed: true, internalType: 'uint256' }, { name: 'player', type: 'address', indexed: true, internalType: 'address' }, { name: 'artifactId', type: 'uint8', indexed: false, internalType: 'uint8' }, { name: 'cellIndex', type: 'uint8', indexed: false, internalType: 'uint8' }, { name: 'nullifier', type: 'bytes32', indexed: false, internalType: 'bytes32' }], anonymous: false },
  { type: 'event', name: 'InventoryCommitmentUpdated', inputs: [{ name: 'gameId', type: 'uint256', indexed: true, internalType: 'uint256' }, { name: 'player', type: 'address', indexed: true, internalType: 'address' }, { name: 'newCommitment', type: 'bytes32', indexed: false, internalType: 'bytes32' }], anonymous: false },
